...
class UnsupportedCategoryAncestors(Exception):
    def __init__(self, categories:list[BiolinkEntity], message:str='Unsupported Category Ancestor') -> None:
...
class UnsupportedPredicateAncestor(Exception):
    def __init__(self, predicates:list[BiolinkEntity], message:str = 'Unsupported Predicate Ancestor') -> None:
        self.message = message
...
class IndeterminableCategoryDescendent(Exception):
    def __init__(self, categories:list[BiolinkEntity], message:str = 'Indeterminable Category Descendent') -> None:
        self.message = message
